...
glimpse_arg.add_argument('--patch_size', nargs='+', type=int, default=[12, 6],
...
glimpse_arg.add_argument('--glimpse_hidden', type=int, default=1024,
...
train_arg.add_argument('--init_lr', type=float, default=1e-1,
